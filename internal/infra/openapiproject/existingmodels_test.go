			...
			Fields: []openapiproject.FieldInfo{
				{
					...
					Tags: "`json:\"id\"`",
					Doc:  "ID is the unique identifier for the user.",
				},
				{
					Name: "Name",
					Type: "string",
					Tags: "`json:\"name\"`",
					Doc:  "Name is the name of the user.",
				},
			},
		},
		"Product": {
			...
			Fields: []openapiproject.FieldInfo{
				{
					...
					Type: "string",
					Tags: "`json:\"sku\"`",
					Doc:  "SKU is the stock keeping unit.",
				},
				{
					Name: "Name",
					Type: "string",
					Tags: "`json:\"name\"`",
					Doc:  "Name is the name of the product.",
				},
				{
					Name: "Price",
					Type: "float64",
					Tags: "`json:\"price\"`",
					Doc:  "Price is the cost of the product.",
				},
			},
		},
	}
