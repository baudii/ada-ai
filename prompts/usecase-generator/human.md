...
1. A Go usecase file containing a function with a placeholder comment and all the context about this handler that you'll need as Go comment blocks:
--- HANDLER_FILE_START ---
   <go file>
--- HANDLER_FILE_END ---
...
* Don’t output the function signature, scope brackets, imports or any unrelated code.
* Write valid, idiomatic Go.

**Dependencies / interfaces:**
When the usecase needs an external call for `data` you should perform this call using an interface of a current resource's repository. Choose 1:
...
* Name of the interface *MUST* have suffix `Repo` (e.g. OrderRepo).
* Assume an interface instance to be a field of a `%s` struct.
